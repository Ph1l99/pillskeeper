...
object UserInformation {
    ...
    @Synchronized
    fun getSpecificMedicine(name: String): LocalMedicine? {
    ...
    @Synchronized
    fun getSpecificFriend(name: String): Friend? {
    ...
    @Synchronized
    fun getSpecificAppointment(name: String): Appointment? {
    ...
    @Synchronized
    fun addNewFriend(friend: Friend): Boolean {
        Log.i(TAG, "addNewFriend() - Started")
        friends.forEach { entry ->
            if (entry.name == friend.name) {
    ...
    @Synchronized
    fun addNewMedicine(medicine: LocalMedicine): Boolean {
        Log.i(TAG, "addNewMedicine() - Started")

        medicines.forEach { entry ->
            if (entry.name == medicine.name && entry.medicineType == medicine.medicineType) {
    ...
    @Synchronized
    fun addNewReminder(medicineName: String, reminder: ReminderMedicine): Boolean {
    ...
    fun addNewAppointment(appointment: Appointment): Boolean {
        ...
        appointments.forEach { entry ->
            if (entry.name == appointment.name) {
    ...
    @Synchronized
    fun editMedicine(oldName: String, medicine: LocalMedicine): Boolean {
    ...
    @Synchronized
    fun editFriend(oldName: String, friend: Friend): Boolean {
    ...
    @Synchronized
    fun subMedicineQuantity(nameMedicine: String, subQty: Float): LocalMedicine? {
    ...
    @Synchronized
    fun restoreQty(medicine: LocalMedicine): Boolean {
        Log.i(TAG, "subMedicineQuantity() - Started")
    ...
    @Synchronized
    fun deleteAppointment(name: String): Boolean {
    ...
    @Synchronized
    fun deleteFriend(name: String): Boolean {
    ...
    @Synchronized
    fun cleanAppointmentAndReminderList() {
